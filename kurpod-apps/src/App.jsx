...
function App() {
  ...
  if (mode === 'unlock') return (
    <div className="flex items-center justify-center min-h-screen bg-default p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-default-500 mt-2">Unlock your storage to continue</p>
        </CardHeader>
    ...
    <div className="flex items-center justify-center min-h-screen bg-default p-4">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          ...
          <h1 className="text-2xl font-bold text-default-900">Create Secure Storage</h1>
          <p className="text-default-500 mt-2">Set up your encrypted storage space</p>
        </CardHeader>
        ...
        <CardBody>
          <form onSubmit={handleInit} className="space-y-6">
            ...
            <fieldset className="border border-divider rounded-lg p-4 space-y-4">
              <legend className="text-sm font-medium text-default-500 px-2">Standard (Decoy) Volume</legend>
              <Input
            ...
            <fieldset className="border border-divider rounded-lg p-4 space-y-4">
              <legend className="text-sm font-medium text-default-500 px-2">Hidden Volume (Optional)</legend>
              <p className="text-xs text-default-500 -mt-2">Provides plausible deniability. Use a different password to access a separate hidden storage area.</p>
              <Input
  ...
  return (
    ...
    <div className="flex h-screen bg-default">
      ...
      {/* Sidebar */}
      <aside className={`
        w-64 border-r border-divider bg-default flex flex-col
      ...
      `}>
        ...
        <div className="p-4 flex flex-col gap-3">
          <label htmlFor="upload-files" className="block">
            <Button 
              variant="bordered" 
              size="sm" 
          ...
          <label htmlFor="upload-folders" className="block">
            <Button 
              variant="bordered" 
              size="sm" 
              className="w-full justify-start cursor-pointer"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Bar */}
        <header className="border-b border-divider bg-default/95 backdrop-blur supports-[backdrop-filter]:bg-default/60 px-4 py-4">
          <div className="flex items-center justify-between">
        ...
        <main 
          className={`flex-1 overflow-auto flex flex-col min-w-0 p-6 ${
            dragActive ? 'bg-primary/5 border-2 border-dashed border-primary/30' : 'bg-default'
          }`}
          ...
          {!selected && !dragActive && (
            <div className="text-center max-w-md w-full p-4 sm:p-10 bg-content1 rounded-xl shadow-sm border border-divider placeholder-container">
              ...
              <div className="flex justify-center">
                <label 
                  htmlFor="main-upload" 
                  className="cursor-pointer inline-flex items-center bg-primary/10 hover:bg-primary/20 text-primary font-semibold py-2 sm:py-3 px-4 sm:px-6 rounded-xl transition-all duration-200 text-sm sm:text-base shadow-sm hover:shadow-md"
                >
