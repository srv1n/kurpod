...
async function getCurrent() {
    return await core.invoke('plugin:deep-link|get_current');
}
/**
...
async function register(protocol) {
    return await core.invoke('plugin:deep-link|register', { protocol });
}
/**
...
async function unregister(protocol) {
    return await core.invoke('plugin:deep-link|unregister', { protocol });
}
/**
...
async function isRegistered(protocol) {
    return await core.invoke('plugin:deep-link|is_registered', { protocol });
}
/**
...
async function onOpenUrl(handler) {
    return await event.listen('deep-link://new-url', (event) => {
