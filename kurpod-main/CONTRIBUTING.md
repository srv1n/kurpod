...
```bash
# Clone your fork
git clone https://github.com/your-username/kurpod.git
cd kurpod

# Add upstream remote
git remote add upstream https://github.com/original-owner/kurpod.git
...
- Join our [Discord server](https://discord.gg/kurpod)
- Follow [@kurpod](https://twitter.com/kurpod) on Twitter
- Read our [blog](https://blog.kurpod.io)
