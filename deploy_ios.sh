...
# enc_tauri/src-tauri/gen/apple/build/arm64/KURPOD.app (for arm64 device builds)
...
# So, the app name is KURPOD.app and target is arm64 for device
APP_BUNDLE_PATH="enc_tauri/src-tauri/gen/apple/build/arm64/KURPOD.app" # Adjust if your app name or structure differs
IPA_PATH="enc_tauri/src-tauri/gen/apple/build/arm64/KURPOD.ipa"
