          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                The only vault you can rename “holiday.png.”
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                All your secrets Images, Videos, Documents packed into one dull file with military-grade encryption.
               
               <br></br> Nothing for the OS or anyone to scan.
              </p>
