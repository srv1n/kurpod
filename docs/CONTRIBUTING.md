# Contributing to ENC Server

Thank you for your interest in contributing to ENC Server! This document provides guidelines for contributing to this open source project.
...
git clone https://github.com/YOUR_USERNAME/enc-server.git
cd enc-server
git remote add upstream https://github.com/yourusername/enc-server.git
```
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/enc-server/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/enc-server/discussions)
...
Every contribution, no matter how small, helps make ENC Server better and more secure for everyone. Thank you for taking the time to contribute!