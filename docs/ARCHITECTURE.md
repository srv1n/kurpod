# ENC Server Architecture

This document provides a comprehensive technical overview of the ENC Server architecture, covering all components from cryptographic implementation to web interface design.
...
ENC Server is designed as a three-tier architecture with clear separation of concerns:
...
ENC Server uses Argon2id for password-based key derivation with the following parameters:
